...
const tasks = [
  {
    input: 'packages/chat-network-view/src/chatNetWorkViewWorkerMain.ts',
    outputDir: '.tmp/dist-chat-network-view/dist',
    outputFile: '.tmp/dist-chat-network-view/dist/chatNetWorkViewWorkerMain.js',
